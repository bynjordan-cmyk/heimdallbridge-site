...
- "categoria" (CLASIFICA SIEMPRE, pero APRENDE DEL USUARIO y sé consistente). Decide en este ORDEN:
  ...
  2) Si NINGUNA categoría del usuario aplica, recién ahí infiere UNA nueva, corta, general y canónica (sustantivo simple, no hiperespecífica): "almuerzo"/"supermercado"→"Alimentación"; "bencina"/"uber"/"micro"→"Transporte"; "luz"/"agua"→"Servicios básicos"; "internet"→"Internet"; "arriendo"→"Arriendo"; "asesoría"/"consultoría"→"Consultoría"; venta de producto→"Ventas"; "sueldo"/"honorarios"→"Honorarios". Mantén estilo consistente con las que ya usa.
  3) Solo si es IMPOSIBLE inferir algo razonable (ej. "gasté 5000", "pagué con tarjeta 4500" sin decir en qué), usa "Sin clasificar" (tanto en ingreso como egreso). NUNCA bloquees ni pidas la categoría como condición para registrar: registra igual con "Sin clasificar". Prefiere esto antes que inventar una categoría dudosa, pero nunca dejes la categoría vacía en un ingreso/egreso.
