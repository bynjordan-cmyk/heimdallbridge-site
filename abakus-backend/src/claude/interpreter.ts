...
- "categoria" (CLASIFICA SIEMPRE, pero APRENDE DEL USUARIO y sé consistente). Decide en este ORDEN:
  ...
  3) Solo si es IMPOSIBLE inferir algo razonable (ej. "gasté 5000" sin ningún contexto), usa "Otros" (egreso) o "Ingresos varios" (ingreso). Prefiere esto antes que inventar una categoría dudosa, pero nunca dejes la categoría vacía en un ingreso/egreso.
